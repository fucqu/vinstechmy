...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} Wireguad installation succes . Please type add-wg to create account"
	exit 1
fi

echo -e "${Info} Wireguard VPS AutoScript by Vinstechmy"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/obitofaiz/vinstechmy/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/obitofaiz/vinstechmy/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/obitofaiz/vinstechmy/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/obitofaiz/vinstechmy/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
