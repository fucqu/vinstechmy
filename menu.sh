...
echo -e "* 14) Extend Wireguard Account Active Life"
echo -e "* 15) Check Wireguard User Interface"
echo -e ""
echo -e "${purple}==================================================${NC}"
echo -e "${green}**********************-L2TP-**********************${NC}"
echo -e "${purple}==================================================${NC}"
echo -e "* 16) Create L2TP Account"
echo -e "* 17) Delete L2TP Account"
echo -e "* 18) Extend L2TP Account Active Life"
echo -e ""
echo -e "${purple}==================================================${NC}"
...
echo -e "* 21) Extend PPTP Account Active Life"
...
echo -e "* 25) Extend SSTP Account Active Life"
...
echo -e "* 28) Delete SSR Account"
echo -e "* 29) Extend SSR Account Active Life"
echo -e "* 30) Show Other SSR Menu"
echo -e ""
echo -e "${purple}==================================================${NC}"
echo -e "${green}*****************-SHADOWSOCKS OBFS-***************${NC}"
echo -e "${purple}==================================================${NC}"
echo -e "* 31) Create Shadowsocks Account"
echo -e "* 32) Delete Shadowsocks Account"
echo -e "* 33) Extend Shadowsocks Account Active Life"
...
echo -e "* 36) Delete V2RAY Vmess Websocket Account"
echo -e "* 37) Extend Vmess Account Active Life"
...
echo -e "* 41) Delete V2RAY Vless Websocket Account"
echo -e "* 42) Extend Vless Account Active Life"
...
echo -e "* 45) Delete Trojan Account"
echo -e "* 46) Extend Trojan Account Active Life"
